...
const Header = (props) => {
  ...
  return (
      <header data-role="Header" className="header-container">
        ...
        <div className="header-icon-group">
          <button className="header-chat-icon" onClick={() => navigate("/Socials/chat")}><img src="/images/socials/chat.svg" width="40px"/></button>
          <button className="header-settings-icon" onClick={() => {props.open(true)}}><img src="/images/socials/settings.svg" width="40px"/></button>
        </div>
